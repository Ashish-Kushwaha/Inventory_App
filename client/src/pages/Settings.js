  ...
  withCredentials: true  
      ...
      toast.success("User Info Saved Successfully")
        ...
        console.log(err);
        toast.error("Something went wrong Email could be a reason not saving your info")
      }finally{
        setLoading(false)
      }
    }
        ...
        </div>
        {
          edit && <div className={styles["edit-profile"]}>
              ...
              <div className={styles["button"]}>
                <button style={{cursor:"pointer"}} disabled={loading} onClick={()=>handleSave()} type='button'>{loading?"Wait":"Save"} </button>
              </div>
          </div>
        }
        {
          account && <div className={styles["edit-profile"]}>
            ...
            <div className={styles["button"]}><button style={{cursor:"pointer"}} onClick={()=>handleLogout()} type='button' disabled={loading} className={styles["log-out"]}>{loading?"Wait":"Log Out"}</button></div>
          </div>
        }
      </div>
    )
